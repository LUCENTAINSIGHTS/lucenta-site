...
const copy = {
  en: {
    ...
    engagementsText: [
      "These examples show the kinds of decision support Lucenta can provide for founder-led and growing businesses.",
      "They are intended to illustrate the nature of the work, not to present named client case studies.",
    ].join(" "),
    engagementMeta: {
      challenge: "Challenge",
  ...
  zh: {
    ...
    servicesText:
      "Lucenta 面向需要更强判断力、更务实诊断与更有把握前进路径的中小企业创始人与管理者。",
    outputs: "典型交付内容",
    services: [
      {
        title: "决策清晰咨询",
    ...
    engagementsText: [
      "以下为合作场景示意，用于展示 Lucenta 可支持的项目类型与工作方式，",
      "并非具名客户案例。",
    ].join(""),
    engagementMeta: {
      challenge: "问题背景",
